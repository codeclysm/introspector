...
func TestJWT(t *testing.T) {
	cases := []struct {
		...
		{"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mpRwH7Klc2P1X93N1f0Qf_W3RcNfxm97xwSLEpgSlIw", "users", "modify", false,
			introspector.Introspection{Active: false, Subject: "test", ExpiresAt: 1486394779, IssuedAt: 1486388779, NotBefore: 1486388779, Issuer: "api.example.cc", Audience: "example", Extra: map[string]interface{}{"user": map[string]interface{}{"email": "test@example.com", "id": "test", "uid": "test"}, "jti": "f85c534c-73ba-4763-a581-23917b977925"}}},
	}
